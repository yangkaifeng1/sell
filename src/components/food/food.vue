		...
		<div class="food" v-show="showFlag" ref="foodWrapper">
			<div class="food-content">
				...
				<div class="ratings">
					...
					<ratingSelect :select-type="selectType" :only-content="onlyContent" @out-selecttype="onSelectType" @out-onlycontent="onOnlyContent" :desc="desc" :ratings="food.ratings"></ratingSelect>
					<div class="rating-wrapper">
						<ul v-show="food.ratings && food.ratings.length">
							<li v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings" class="rating-item border-1px">
								...
								<div class="time">{{dates(rating.rateTime)}}</div>
								<p class="text">
...
<script>
	...
	export default {
		...
		methods: {
			...
			onSelectType (type) {
				if (type === undefined) {
					return this.selectType = this.selectType;
				}
			...
			hdie () {
				this.showFlag = false;
				this.onSelectType(ALL);
        		this.onOnlyContent(false);
			},
			addFirst (event) {
